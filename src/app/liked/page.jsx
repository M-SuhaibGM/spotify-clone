    ...
    <>
      <div className="home text-white h-[93vh] w-[77vw]  bg-neutral-800 my-5  overflow-y-auto  hide-scroll ">
        <div className="bg-gradient-to-b from-emerald-800 pt-10 ">
          ...
          <div
            className="cursor-pointer  mx-5 flex h-[104px] w-[350px] items-center gap-5 bg-neutral-500 group"  >
            <FaHeart className='text-red-600 ml-3 w-[70px] size-20' />
            <text className='text-[40px] text-white'>Liked Songs</text>
          </div>

          <div className="flex text-white text-[30px] font-bold p-5">Liked Songs</div>
        </div>
